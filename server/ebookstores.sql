...
series_id INT NOT NULL,
 ...
 order_history_id INT AUTO_INCREMENT PRIMARY
 KEY,
 ...
 FOREIGN KEY (customer_id) REFERENCES
 Customer_account(username),
 FOREIGN KEY (discount_id) REFERENCES
 Discount(discount_id),
 FOREIGN KEY (order_history_id) REFERENCES
...
order_id INT NOT NULL,
 ...
 favorite_list_id INT AUTO_INCREMENT PRIMARY
 KEY,
 username VARCHAR(15) NOT NULL,
 FOREIGN KEY (username) REFERENCES
 Customer_account(username)
 ...
 Favorite_list(favorite_list_id)
 );
 CREATE TABLE Genre (
